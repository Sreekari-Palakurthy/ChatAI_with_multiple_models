...
from user.helpers import get_openai_models
from user.helpers import validate_anthropic_key
from user.helpers import get_mistral_models
...
def get_all_models():
    return {
        ...
        "anthropic_models": validate_anthropic_key()
    }